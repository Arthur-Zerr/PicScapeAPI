...
namespace PicScapeAPI.Migrations
{
    ...
    [Migration("20200319084333_AddUploadIdtoModels")]
    partial class AddUploadIdtoModels
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PicScapeAPI.DAL.Models.UserRegistrationActivity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("UserRegistrationActivitys");
                });
            ...
            modelBuilder.Entity("PicScapeAPI.DAL.Models.Picture", b =>
                {
                    b.HasOne("PicScapeAPI.DAL.Models.User", null)
                        .WithMany("Pictures")
                        .HasForeignKey("UserID");
                });
